                    ...
                    <div class="card-body">
                        <form action="{{ route('user.simpan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cst_name" value="{{ old('cst_name') }}" placeholder="Masukkan Nama">
                            </div>
                            <div class="form-group">
                                <label class="font-weight-bold">Tanggal Lahir</label>
                                <input type="date" class="form-control" name="cst_dob" value="{{ old('cst_dob') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="nationality" class="form-control">
                                    ...
                                    <option value="{{$val->nationality_id}}">{{$val->nationality_name}}</option>
                                    @endforeach
                                </select>
                            </div>
